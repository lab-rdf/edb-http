...
public class Groups {
  ...
  private static final String GROUP_IDS_SQL = "SELECT groups_persons.group_id FROM groups_persons WHERE groups_persons.person_id = ?";
  ...
  private static final String SAMPLE_GROUPS_COUNT_SQL = "SELECT COUNT(id) FROM groups_samples WHERE groups_samples.sample_id = ? AND groups_samples.group_id = ANY(?::int[])";

  /** The Constant SAMPLE_GROUP_COUNT_SQL. */
  private static final String SAMPLE_GROUP_COUNT_SQL = "SELECT COUNT(id) FROM groups_samples WHERE groups_samples.sample_id = ? AND groups_samples.group_id = ?";

  /** The Constant GROUP_SAMPLES_SQL. */
  private static final String GROUP_SAMPLES_SQL = "SELECT groups_samples.sample_id FROM groups_samples WHERE groups_samples.group_id = ANY(?::int[])";

  public static final String GROUPS_SQL = "SELECT groups.id, groups.name, groups.color FROM groups ORDER BY groups.name";

  public static final String GROUP_SQL = "SELECT groups.id, groups.name, groups.color FROM groups WHERE groups.id = ?";
