...
public class Persons {
  ...
  private static final String PERSON_SQL = PERSONS_SQL + " WHERE persons.id = ?";
  ...
  public static PersonBean getPerson(JdbcTemplate jdbcTemplate, int id) throws SQLException {
  ...
  public static List<PersonBean> getPersons(JdbcTemplate jdbcTemplate, int id) throws SQLException {
    return Query.query(jdbcTemplate, PERSON_SQL, id, new RowMapper<PersonBean>() {
      @Override
      public PersonBean mapRow(ResultSet rs, int rowNum) throws SQLException {

        return new PersonBean(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5));
      }
    });
  }

  public static List<PersonBean> getPersons(JdbcTemplate jdbcTemplate, Collection<Integer> ids) throws SQLException {
    return Query.query(jdbcTemplate, PERSON_SQL, ids, new RowMapper<PersonBean>() {
      @Override
      public PersonBean mapRow(ResultSet rs, int rowNum) throws SQLException {
